...
const RoutineCard = ({ data }) => {
  ...
  return (
    <div className="flex w-full font-manrope">
      <div className="group relative mx-2 my-3 flex min-h-[80px] w-full max-w-[95%] cursor-pointer items-center justify-between rounded-lg border border-t bg-white p-3 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md dark:border-gray-700 dark:bg-gray-800 sm:mx-3 sm:my-4 sm:min-h-[90px] sm:p-5 lg:max-w-4xl">
