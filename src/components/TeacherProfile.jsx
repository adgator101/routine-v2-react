...
const TeacherProfile = () => {
  return (
    <div className="teacher-modal-container flex-center h-full w-full border-2 bg-black bg-opacity-20 ">
      <div className="teacher-profile-container flex flex-col items-center gap-5 rounded-xl p-5 text-center bg-white">
        ...
        <div className="teacher-details-right flex flex-col gap-5">
          <h1 className="text-xl font-bold">Mr. Arvind Nepal</h1>
          <p className="text-sm text-[#A8A6AC]">
